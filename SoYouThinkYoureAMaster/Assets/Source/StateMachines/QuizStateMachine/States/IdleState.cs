...
public class IdleState : BaseState
{
    ...
    public IdleState()
    {
        this.StateType = StateTypes.IdleState;
    }
    ...
    {
        QuizManager.GetInstance().QuizUIController.SetupQuestion(QuizManager.GetInstance().CurrentQuestion(), QuizManager.GetInstance().HandlerUserAnswer);
        base.OnEnter();
    } 
    ...
    {
        QuizManager.GetInstance().NextQuestion();
        base.OnExit();
    }

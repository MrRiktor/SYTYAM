...
public sealed class ChampionDBManager : MonoBehaviour
{
    ...
    void Start()
    {
        StartCoroutine( InitializeChampionDatabase(Region.RegionEnum.na, ChampData.all ) );
    }
    ...
    private void InitializationFailure(string message)
    {
        ...
        {
            Fetch fetch = new Fetch(InitializationSuccess, null, ChampionDB.fromJSON, "Assets/Resources/BackupChampionData/champion.json");
        }
